...
# в первом хранятся ФИО пользователей сайта, а во втором — данные об их хобби.
...
# ключи — ФИО, значения — данные о хобби (список строковых переменных).
...
def prepare_dataset(path_users_file: str, path_hobby_file: str) -> dict:
    ...
    with open('users.csv', 'r', encoding='utf-8') as f1, open('hobby.csv', 'r', encoding='utf-8') as f2:
        ...
        for str_users in f1:
            list_users.append(str_users.replace(',', ' ').strip())

        list_hobby = []
        for str_hobby in f2:
            list_hobby.append(str_hobby.strip().split(','))
